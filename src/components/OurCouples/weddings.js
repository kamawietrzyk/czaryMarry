const weddings = [
    ...
    },
    {
        ...
        flowersLink: "http://pracowniazieleni.pl/",
        photos: {
            pic1: require('./OurCouplesPics/FoodtruckWedding/ft1.JPG').default,
            pic2: require('./OurCouplesPics/FoodtruckWedding/ft2.JPG').default,
            pic3: require('./OurCouplesPics/FoodtruckWedding/ft3.JPG').default,
            pic4: require('./OurCouplesPics/FoodtruckWedding/ft4.JPG').default,
            pic5: require('./OurCouplesPics/FoodtruckWedding/ft5.JPG').default,
            pic6: require('./OurCouplesPics/FoodtruckWedding/ft6.JPG').default,
            pic7: require('./OurCouplesPics/FoodtruckWedding/ft7.JPG').default,
            pic8: require('./OurCouplesPics/FoodtruckWedding/ft8.JPG').default,
            pic9: require('./OurCouplesPics/FoodtruckWedding/ft9.JPG').default,
            pic10: require('./OurCouplesPics/FoodtruckWedding/ft10.JPG').default,
            pic11: require('./OurCouplesPics/FoodtruckWedding/ft11.JPG').default,
            pic12: require('./OurCouplesPics/FoodtruckWedding/ft12.JPG').default,
            pic13: require('./OurCouplesPics/FoodtruckWedding/ft13.JPG').default,
            pic14: require('./OurCouplesPics/FoodtruckWedding/ft14.JPG').default,
            pic15: require('./OurCouplesPics/FoodtruckWedding/ft15.JPG').default,
            pic16: require('./OurCouplesPics/FoodtruckWedding/ft16.JPG').default,
            picVer1: require('./OurCouplesPics/FoodtruckWedding/ftVer1.jpg').default,
            picVer2: require('./OurCouplesPics/FoodtruckWedding/ftVer2.jpg').default,
            picVer3: require('./OurCouplesPics/FoodtruckWedding/ftVer3.jpg').default,
            picVer4: require('./OurCouplesPics/FoodtruckWedding/ftVer5.jpg').default,
            picVer5: require('./OurCouplesPics/FoodtruckWedding/ftVer4.jpg').default,
            picVer6: require('./OurCouplesPics/FoodtruckWedding/ftVer6.jpg').default,
            picVer7: require('./OurCouplesPics/FoodtruckWedding/ftVer7.jpg').default,
    ...
    },
    {
        ...
        photos: {
            ...
            picVer1: require('./OurCouplesPics/NellyPiotr/ver1.JPG').default,
            picVer2: require('./OurCouplesPics/NellyPiotr/ver2.JPG').default,
            picVer3: require('./OurCouplesPics/NellyPiotr/ver3.JPG').default,
