...
const offerDetails = [
    ...
    { color: "bgMint", number: "02", title: "Koordynacja ślubu i wesela", text: <>Będziemy do Waszej dyspozycji w dniu ślubu. Dopilnujemy, aby wszystko przebiegło tak jak to sobie zaplanowaliście, a Wam pozostawimy świętowanie. Stworzymy <CustomPostLink text="scenariusz uroczystości" path="plan-wesela-harmonogram-dnia-slubu-krok-po-kroku" className="linkDark" />, będziemy w kontakcie z wykonawcami oraz salą weselną.</> },
    { color: "bgGrey", number: "03", title: "Wybrane elementy", text: <>Potrzebujecie pomocy tylko przy części usług? To usługa stworzona specjalnie dla Was! To Wy decydujecie w jakim stopniu chcecie nas zaangażować w <CustomPostLink text="przygotowania" path="przygotowania-do-slubu-formalnosci" className="linkDark" />.</> },
